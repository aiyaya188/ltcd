...
type Params struct {
	...
	BtcPubKeyHashAddrID        byte // First byte of a P2PKH address
	BtcScriptHashAddrID        byte // First byte of a P2SH address
...
var MainNetParams = Params{
	...
	BtcPubKeyHashAddrID:        0x00, // starts with 1
	BtcScriptHashAddrID:        0x05, // starts with 3
